...
router.post('/',check_authentication(constants.ADMIN_PERMISSION), async function (req, res, next) {
  try {
    let body = req.body
...
router.put('/:id',check_authentication(constants.ADMIN_PERMISSION), async function (req, res, next) {
  try {
